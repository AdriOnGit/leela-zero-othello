...
// More general hash of the board state which takes into account prisoners, the last move made, and the current player to move. 
// You can apply a function to transform the values before hashing.
...
// Flips all vertexes from starting to end in direction d; 
// If you can't get from start to end through direction dir, segmentation fault.
