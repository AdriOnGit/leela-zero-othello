...
// Zobrist Hash: tecnique used to efficiently generate a unique hash value for every possible game configuration.
// Used in tabletop games for position search.


std::array<std::array<std::uint64_t, FastBoard::NUM_VERTICES>,     4> Zobrist::zobrist;
std::array<std::uint64_t, 5>                                          Zobrist::zobrist_pass;

// Generates random values and assings them to each cell of the two matrices and the two vectors.
